 ...
 */
	...
	class Nav_Walker extends \Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			...
			$fallback_title =  !empty($args['fallback_title'])? $args['fallback_title'] : esc_attr__( 'Add a menu', 'citykid' );
			$fallback_output .= '<ul' . $id . $class . '>';
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . $fallback_title . '">' . $fallback_title . '</a></li>';
			$fallback_output .= '</ul>';
